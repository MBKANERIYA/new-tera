...
export default function PropertyCollection() {
  ...
  const handleCardClick = (item, e) => {
    ...
    navigate(generatePropertyUrl(item._id, item.title));
  };
  ...
  // Sync filter state with URL params when navigating from header dropdowns
  React.useEffect(() => {
    ...
    setSelectedPropertyTypes(propertyTypes.length > 0 ? propertyTypes : []);
  ...
  // Property types available after applying listing type, budget, and search filters (but NOT property type filter)
  const availablePropertyTypes = Array.from(new Set(
    propertiesData.filter(p => {
      ...
      return matchListing && matchBudget && matchSearch;
    }).map(p => p.type)
  ));
  ...
  const handlePropertyTypeChange = (type) => {
    ...
    newTypes.forEach(t => params.append('propertyType', t));
        ...
        <div className="w-full lg:w-[280px] shrink-0 space-y-6 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="bg-white p-5 rounded shadow-sm border border-gray-100">
              ...
              <div className="flex bg-gray-100 p-1 rounded">
                {['All', 'Sale', 'Lease'].map(type => (
                  <button
                    ...
                    className={`flex-1 text-[13px] py-1.5 rounded font-medium transition-colors ${activeListingType === type
                ...
                {availablePropertyTypes.map(type => (
                  <label key={type} className="flex items-center gap-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 text-black rounded border-gray-300 focus:ring-blue-500"
                    />
            ...
            <button
              ...
              className="w-full bg-black hover:bg-[#515A63] text-white py-2.5 rounded font-bold transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="bg-white p-4 rounded shadow-sm border border-gray-100 mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <select
                ...
                className="border border-gray-200 rounded p-1.5 text-[13px] text-gray-700 focus:outline-none focus:border-blue-500 bg-gray-50"
              >
                ...
                >
                  <div className="flex flex-col sm:flex-row p-4 gap-5">
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <Link to={generatePropertyUrl(item._id, item.title)} className="text-[17px] text-[#000000] hover:underline font-medium leading-snug mb-4">
                        {item.title}
                      </Link>
                      ...
                      <p className="text-[13px] text-gray-600 line-clamp-2 mb-4 leading-relaxed">
                        {item.description} <Link to={generatePropertyUrl(item._id, item.title)} className="text-black hover:underline ml-1">...more</Link>
                      </p>
                  ...
                  <div className="border-t border-gray-100 px-5 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      ...
                      <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-[#000000] hover:bg-[#1e3466] text-white py-2 px-5 rounded font-medium text-[13px] transition-colors">
              ...
              <div className="flex items-center gap-1 bg-white border border-gray-200 rounded shadow-sm p-1">
                ...
                {getVisiblePages().map((pageNum) => (
                  <button
                    ...
                    className={`px-3 py-1.5 font-medium rounded transition-colors ${currentPage === pageNum ? 'bg-black text-white' : 'text-gray-600 hover:bg-gray-100'}`}
                  >
                    {pageNum}
                  </button>
                ))}
                ...
                {inquiryStatus === 'success' ? (
                  ...
                  <form onSubmit={handleInquirySubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full bg-black hover:bg-[#515A63] text-white font-bold py-3 rounded transition-colors mt-4 flex justify-center items-center gap-2 disabled:opacity-70"
                    >
