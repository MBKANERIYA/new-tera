...
export default function AdminPostProperty() {
  ...
  const [formData, setFormData] = useState({
    ...
    status: 'approved', submittedBy: '1', tags: '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = id ? `http://localhost:5001/api/properties/${id}` : 'http://localhost:5001/api/properties';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100/50 pb-20 font-sans selection:bg-purple-100 selection:text-purple-900">
      ...
      <main className="max-w-7xl mx-auto pt-10 px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <span className="inline-block py-1 px-3 rounded-full bg-purple-100 text-purple-700 text-xs font-bold tracking-widest uppercase mb-3">Admin Portal</span>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">{id ? 'Edit Property' : 'List a New Property'}</h1>
